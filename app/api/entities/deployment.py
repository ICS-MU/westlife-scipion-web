...
class DeploymentEntity(BaseEntity):
    ...
    def set_onedata_access_token(self, deployment_onedata_access_token: str) -> "DeploymentEntity":
...
class DeploymentEntityFactory(BaseEntityFactory):
    ...
    def create_from_post_data(self, data: dict, check_mandatory_items: bool = True) -> DeploymentEntity:
        ...
        try:
            ...
            if "onedata_access_token" in data:
                deployment.set_onedata_access_token(data['onedata_access_token'])
            return deployment
